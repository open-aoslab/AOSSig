...
class Render:
    def __init__(self, cfg: RenderCfg):
        ...
        self.bg_manager = BgManager(cfg.bg_dir, cfg.pre_load_bg_img)  #背景管理器
    ...
    def gen_single_corpus(self) -> Tuple[PILImage, str, PILImage, PILImage]:
        font_text = self.corpus.sample() # Font 和 font_text 
        ...
        transformed_text_mask.save('transforrmer.png')
