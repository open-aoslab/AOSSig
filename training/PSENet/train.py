...
def save_checkpoint(state, checkpoint_path, cfg):
    file_path = osp.join(checkpoint_path, str(state['epoch'])+'_'+'checkpoint.pth.tar')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='config/psenet/psenet_r50_ic15_736.py', type=str, help='config file path')
