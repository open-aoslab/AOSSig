...
class Line(Effect):
    ...
    def apply_bottom(self, img, text_bbox):
    ...
    def apply_top(self, img, text_bbox):
        in_offset, thickness, out_offset = self._get_tb_param()
    ...
    def apply_right(self, img, text_bbox) :
    ...
    def apply_left(self, img, text_bbox):
        in_offset, thickness, out_offset = self._get_lr_param()
    ...
    def apply_top_left(self, img, text_bbox):
        ret = self.apply_top(img, text_bbox)
        return self.apply_left(*ret)

    def apply_top_right(self, img, text_bbox):
        ret = self.apply_top(img, text_bbox)
