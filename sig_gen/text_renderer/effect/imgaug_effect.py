...
Date: 2023-06-01 03:07:39
LastEditTime: 2023-05-31 20:19:52
...
class PerspectiveTransform(ImgAugEffect):
    def __init__(self, p=1.0, scale=(0.01, 0.08)):
        super().__init__(p, iaa.PerspectiveTransform(scale=scale))
