...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoints/psenet_r50_ic15_736/2_checkpoint.pth.tar')
    # parser.add_argument('--checkpoint', type=str, default="/nas-02/ssd/shifang/PSE_weight/checkpoint_epoch6.pth.tar")
